...
namespace CRUD.CommonLayer.Models
{
    ...
    public class EDeleteInformation
    {
    ...
    public class WDeleteInformation
    {
        public int Id { get; set; }
    ...
    public class SDeleteInformation
    {
        public int Id { get; set; }
        public string Name { get; set; }
        public string CardNo { get; set; }
    ...
    public class JDeleteInformation
    {
    ...
    public class JSDeleteInformation
    {
        public int SectionsId { get; set; }
        public string SectionsName { get; set; }
    }

    public class LVTDeleteInformation
    {
        public int Id { get; set; }
    ...
    public class EmpATTDeleteInformation
    {
    ...
    public class WorkATTDeleteInformation
    {
        public int EntryId { get; set; }
        public int Id { get; set; }
        public string Name { get; set; }
